...
labels <- fread("C:/Users/SORU/Downloads/orange_large_train_churn.csv")
...
new_desc = makeOMLDataSetDescription(
  ...
  name = "kddcup2009_churn",
  description = paste("Small version of KDD 2009 Cup data with churn label"),
...
# Data set successfully uploaded. Data set ID: 43907

#deleteOMLObject(43907, object = c("data"), verbosity = NULL)
